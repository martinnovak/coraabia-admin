...
/**
 * @kapafaa eff.gameplay(%target%.sacrificeCardsFromDeck %modification%%multiply%)
 * @description Obětování karet z balíku
 */
class SacrificeCardsFromDeck extends Effect
{
