...
/**
 * @kapafaa eff.gameplay(%target%.playableChampionsPerDuel %modification%%multiply%)
 * @description Hratelní šampioni za duel
 */
class PlayableChampionsPerDuel extends Effect
{
