 ...
 */
class PlayableTricksPerDuel extends GameEffect
{
	const PLAYABLE_TRICKS_PER_DUEL = 'playableTricksPerDuel';
	...
	{
		parent::__construct(self::PLAYABLE_TRICKS_PER_DUEL, $target, $multiply);
