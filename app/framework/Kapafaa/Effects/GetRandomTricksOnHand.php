 ...
 */
class GetRandomTricksOnHand extends GameEffect
{
	const GET_RANDOM_TRICKS_ON_HAND = 'getRandomTricksOnHand';
	...
	{
		parent::__construct(self::GET_RANDOM_TRICKS_ON_HAND, $target, $multiply);
