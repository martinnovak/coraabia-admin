...
/**
 * @kapafaa eff.gameplay(%target%.getRandomChampionsOnHand %modification%%multiply%)
 * @description Náhodní šampioni na ruku
 */
class GetRandomChampionsOnHand extends Effect
{
