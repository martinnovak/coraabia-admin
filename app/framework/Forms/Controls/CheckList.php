...
class CheckList extends Nette\Forms\Controls\BaseControl
{
	...
	public function getValue($raw = FALSE)
	{
		...
		return array_diff_key(array_flip($this->value), $this->items) == array() ? $this->value : NULL;
	}
	...
	public function getControl($key = NULL)
	{
		...
		$input = parent::getControl()->type('checkbox');
